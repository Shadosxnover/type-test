...
function AboutContact() {
  return (
    <div className="max-w-3xl mx-auto p-4">
      ...
      <p className="mb-4">
        TypeTest is a modern typing speed test application designed to help you improve your typing skills.
      ...
      <p className="flex items-center">
        ...
        <a href="mailto:contact@typetest.com" className="text-blue-500 hover:underline">
          contact@typetest.com
        </a>
      </p>
    </div>
  );
